...
This will create an HTML file, `diamond-sizes.html`, that you can open in your browser, as shown in @fig-diamond-sizes-report.
...
Then when you render (click "Render" or press Cmd/Ctrl + Shift + K), the report will appear as shown in @fig-diamond-sizes-report-viewer.
