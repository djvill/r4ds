...
Beyond that, R gives you wide latitude for choosing object names.
...
You can inspect an object by running an R expression consisting of just its name:
...
While I won't ask you to submit exercise answers as homework, I *strongly* encourage you to try them out on your own as you read through the chapter.
You can find exercise solutions for the first 9 chapters at <https://mine-cetinkaya-rundel.github.io/r4ds-solutions/>.
:::
...
2.  Tweak each of the following R commands so that they run correctly:
    ...
    Occasionally we'll cover chapters out of order, so feel free to skip exercises (like this one) that cover material we haven't gotten to yet.
    :::
