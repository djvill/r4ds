...
1.  There's a specific advantage to placing variables in columns because
    ...
    [mutate](#mutate-funs) and [summary functions](#summarise-funs), most 
...
<span class="warning">
Not all missing values are "bad". In language data, we have "structural missings", where a given variable might not apply to a given observation. For example, if you have a table of phonemes, with columns `voicing`, `place`, `manner`, `height`, `frontness`, etc., the `manner` column won't apply to vowel phonemes.
</span>
...
<span class="warning>
I'll add a third: if you're formatting your data as a table for publication, a non-tidy format may be more information-dense. For example, `table3` might be more suitable than showing cases & population in different columns
</span>

Either of these reasons means you'll need something other than a tibble (or data frame). If your data does fit naturally into a rectangular structure composed of observations and variables, I think tidy data should be your default choice. But there are good reasons to use other structures; tidy data is not the only way.

If you'd like to learn more about non-tidy data, I'd highly recommend this thoughtful blog post by Jeff Leek: <https://web.archive.org/web/20171015004647/https://simplystatistics.org/2016/02/17/non-tidy-data/>
