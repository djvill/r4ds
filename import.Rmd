...
<span class="warning">
(Dan) I've never used `read_fwf()` or `read_log()`, but it's good to know about them!
</span>
...
<span class="warning">
Feel free to skip or skim this section
</span>
...
<span class="warning">
For the `col_types` argument, you can also supply a compact string representation (e.g., `"dl"` for "double then logical"). See `?read_csv` for more info.
</span>
