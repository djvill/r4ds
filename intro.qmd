...
If you haven't yet, please remember to update R to version 4.5.1 (see instructions [here](https://djvill.github.io/Data-Sci-2025/#update-r)).
:::
...
In R, run `tidyverse::tidyverse_deps()`, and include the output in your To-do 1 submission.
:::
